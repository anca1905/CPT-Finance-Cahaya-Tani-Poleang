...
// Ambil Header
$q_header = $conn->query("
    SELECT t.*, p.nama_pemasok, p.alamat, p.no_hp 
...
$q_detail = $conn->query("
    ...
    FROM tb_transaksi_pembelian_detail d 
...
<head>
    ...
    <title>Nota Pembelian - <?= $header['no_transaksi'] ?></title>
    <style>
...
<body onload="window.print()">
    <div class="nota-container">
        <div class="header">
            <h2>CTP FINANCE</h2>
            <p>Bukti Pembelian (Terima Barang)</p>
        </div>
        ...
        <table class="info-table">
            <tr>
                ...
                <td width="2%">:</td>
                <td width="33%"><b><?= $header['nama_pemasok'] ?></b></td>
            </tr>
            <tr>
                <td>Tanggal</td>
                <td>:</td>
